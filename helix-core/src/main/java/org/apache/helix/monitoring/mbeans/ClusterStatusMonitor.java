        ...
        for (String resource : resourceSet) {
            ...
            for (Partition partition : partitionStateMap.keySet()) {
                ...
                for (String instance : instanceStateMap.keySet()) {
                    ...
                    PerInstanceResourceMonitor.BeanName beanName = new PerInstanceResourceMonitor.BeanName(instance,
                            resource);
    ...
    public void refreshJobsStatus(TaskDriver driver) {
        ...
        for (String workflow : driver.getWorkflows().keySet()) {
            ...
            for (String job : allJobs) {
                TaskState currentState = workflowContext == null ? TaskState.NOT_STARTED : workflowContext.getJobState(
                        job);
