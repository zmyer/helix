...
public class HelixRestNamespace {
    ...
    public HelixRestNamespace(String name, HelixMetadataStoreType metadataStoreType, String metadataStoreAddress,
            boolean isDefault)
    ...
    private void validate() throws IllegalArgumentException {
        ...
        if (_metadataStoreType != HelixMetadataStoreType.NO_METADATA_STORE && (_metadataStoreAddress == null
            ...
            throw new IllegalArgumentException(
                    String.format("Metadata store address \"%s\" is not valid for namespace %s", _metadataStoreAddress,
                            _name));
        }
    }
